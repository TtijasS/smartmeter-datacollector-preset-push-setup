...
import smartmeter_datacollector.smartmeter.pushlist_presets as pushlist_presets
    ...
    def parse_to_dlms_objects(self) -> List[GXDLMSObject]:
        ...
        if isinstance(self._dlms_data.value[0], list):
            ...
            if not dlms_objects:
                ...
                if len(self._dlms_data.value) == 12:
                    self._dlms_data.value.insert(0, pushlist_presets.telegram_len_12)
                elif len(self._dlms_data.value) == 18:
                    self._dlms_data.value.insert(0, pushlist_presets.telegram_len_18)
                else:
